...
public class BoardService {
    ...
    public Page<Board> boardSearchListByContents(String searchKeyword, Pageable pageable){
    ...
    public Page<Board> boardSearchListByAll(String searchKeyword, Pageable pageable){

        return boardRepository.findByTitleContainingAndWriterContainingAndContentsContaining(searchKeyword, searchKeyword, searchKeyword, pageable);
    }
